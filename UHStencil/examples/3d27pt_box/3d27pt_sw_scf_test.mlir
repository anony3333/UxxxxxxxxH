module  {
  func @stencil_3d27pt_box(%arg0: memref<258x258x258xf64>, %arg1: memref<258x258x258xf64>) attributes {hardware = "sw", llvm.emit_c_interface, std.stencil_program} {
    // ###### test arithmetic op lowering ######
    // %c1 = constant 1.0e-1 : f64
    // %c2 = constant 2.0e-1 : f64
    // %1 = addf %c1, %c2 : f64
    // %2 = subf %c1, %c2 : f64
    // %3 = mulf %c1, %c2 : f64
    // %4 = divf %c1, %c2 : f64
    ...
    // ###### test memref.load / memref.store ######
    // %c1 = constant 1 : index
    // %1 = memref.load %arg0[%c1, %c1, %c1] : memref<258x258x258xf64>
    // %c2 = constant 2.0 : f64
    // memref.store %c2, %arg0[%c1, %c1, %c1] : memref<258x258x258xf64>
    ...
    //   %0 = memref.alloc() {readOrWrite = "write", swdma_bsize = 16 : index, swdma_cnt = 256 : index, swdma_stride = 242 : index, swdma_zDim = 16 : index} : memref<16x16x16xf64, 3>
    //   %1 = memref.alloc() {readOrWrite = "read", swdma_bsize = 18 : index, swdma_cnt = 324 : index, swdma_stride = 240 : index, swdma_zDim = 18 : index} : memref<18x18x18xf64, 3>
    //   %c128 = constant 128 : index
    //   %2 = muli %arg4, %c128 : index
    //   %c64 = constant 64 : index
    //   %3 = muli %arg3, %c64 : index
    //   %c32 = constant 32 : index
    //   %4 = muli %arg2, %c32 : index
    // }
      ...
      scf.for %arg5 = %1 to %2 step %c16 {
        ...
        scf.for %arg6 = %4 to %5 step %c16 {
          ...
          scf.for %arg7 = %7 to %8 step %c16 {
            %9 = memref.alloc() {readOrWrite = "write", swdma_bsize = 16 : i64, swdma_cnt = 256 : i64, swdma_stride = 242 : i64, swdma_zDim = 16 : i64, halo = 1 : i64} : memref<16x16x16xf64, 3>
            %10 = memref.alloc() {readOrWrite = "read", swdma_bsize = 18 : i64, swdma_cnt = 324 : i64, swdma_stride = 240 : i64, swdma_zDim = 18 : i64, halo = 1 : i64} : memref<18x18x18xf64, 3>
            gpu.barrier
    ...
    // sw.main_return // error: 'sw.main_return' op expects parent op 'sw.main_func'
    // sw.terminator // error: 'sw.terminator' op expects parent op 'sw.launch'
    // sw.return // error: 'sw.return' op expects parent op 'sw.func'
  }
  func @stencil_3d27pt_box_iteration(%arg0: memref<258x258x258xf64>, %arg1: memref<258x258x258xf64>) attributes {llvm.emit_c_interface, std.stencil_iteration} {
    ...
    scf.for %arg2 = %c0 to %c1 step %c1 {
      // error: failed to legalize operation 'std.call'
