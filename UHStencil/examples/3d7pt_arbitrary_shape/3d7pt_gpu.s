...
.Lfunc_begin0:
	.file	1 "/home/jzh/mlir_stencil/SWStenDSL/examples/3d7pt_arbitrary_shape" "3d7pt_gpu.mlir"
	.loc	1 5 0                           # 3d7pt_gpu.mlir:5:0
	.cfi_startproc
# %bb.0:
	pushq	%rbp
	...
	movq	%rdi, %r12
.Ltmp0:
	.loc	1 35 11 prologue_end            # 3d7pt_gpu.mlir:35:11
	movl	$137388096, %edi                # imm = 0x8306040
	callq	malloc@PLT
	.loc	1 61 11                         # 3d7pt_gpu.mlir:61:11
	movl	$stencil_3d7pt_kernel_gpubin_cst, %edi
	callq	mgpuModuleLoad@PLT
	movq	%rax, 16(%rsp)                  # 8-byte Spill
	.loc	1 65 11                         # 3d7pt_gpu.mlir:65:11
	movl	$stencil_3d7pt_kernel_stencil_3d7pt_kernel_kernel_name, %esi
	movq	%rax, %rdi
	callq	mgpuModuleGetFunction@PLT
	movq	%rax, 8(%rsp)                   # 8-byte Spill
	.loc	1 67 11                         # 3d7pt_gpu.mlir:67:11
	callq	mgpuStreamCreate@PLT
	movq	%rax, %rbx
	.loc	1 93 5                          # 3d7pt_gpu.mlir:93:5
	movq	%r12, 24(%rsp)
	leaq	24(%rsp), %rax
	.loc	1 96 5                          # 3d7pt_gpu.mlir:96:5
	movq	%rax, 168(%rsp)
	.loc	1 99 5                          # 3d7pt_gpu.mlir:99:5
	movq	%r14, 32(%rsp)
	.loc	1 98 11                         # 3d7pt_gpu.mlir:98:11
	leaq	32(%rsp), %rax
	.loc	1 102 5                         # 3d7pt_gpu.mlir:102:5
	movq	%rax, 176(%rsp)
	.loc	1 105 5                         # 3d7pt_gpu.mlir:105:5
	movq	%r15, 40(%rsp)
	.loc	1 104 11                        # 3d7pt_gpu.mlir:104:11
	leaq	40(%rsp), %rax
	.loc	1 108 5                         # 3d7pt_gpu.mlir:108:5
	movq	%rax, 184(%rsp)
	.loc	1 111 5                         # 3d7pt_gpu.mlir:111:5
	movq	%rbp, 48(%rsp)
	.loc	1 110 11                        # 3d7pt_gpu.mlir:110:11
	leaq	48(%rsp), %rax
	.loc	1 114 5                         # 3d7pt_gpu.mlir:114:5
	movq	%rax, 192(%rsp)
	.loc	1 117 5                         # 3d7pt_gpu.mlir:117:5
	movq	%r13, 56(%rsp)
	.loc	1 116 12                        # 3d7pt_gpu.mlir:116:12
	leaq	56(%rsp), %rax
	.loc	1 120 5                         # 3d7pt_gpu.mlir:120:5
	movq	%rax, 200(%rsp)
	movq	(%rsp), %rax                    # 8-byte Reload
	.loc	1 123 5                         # 3d7pt_gpu.mlir:123:5
	movq	%rax, 64(%rsp)
	.loc	1 122 12                        # 3d7pt_gpu.mlir:122:12
	leaq	64(%rsp), %rax
	.loc	1 126 5                         # 3d7pt_gpu.mlir:126:5
	movq	%rax, 208(%rsp)
	.loc	1 129 5                         # 3d7pt_gpu.mlir:129:5
	movq	368(%rsp), %rax
	movq	%rax, 72(%rsp)
	.loc	1 128 12                        # 3d7pt_gpu.mlir:128:12
	leaq	72(%rsp), %rax
	.loc	1 132 5                         # 3d7pt_gpu.mlir:132:5
	movq	%rax, 216(%rsp)
	.loc	1 135 5                         # 3d7pt_gpu.mlir:135:5
	movq	376(%rsp), %rax
	movq	%rax, 80(%rsp)
	.loc	1 134 12                        # 3d7pt_gpu.mlir:134:12
	leaq	80(%rsp), %rax
	.loc	1 138 5                         # 3d7pt_gpu.mlir:138:5
	movq	%rax, 224(%rsp)
	.loc	1 141 5                         # 3d7pt_gpu.mlir:141:5
	movq	384(%rsp), %rax
	movq	%rax, 88(%rsp)
	.loc	1 140 12                        # 3d7pt_gpu.mlir:140:12
	leaq	88(%rsp), %rax
	.loc	1 144 5                         # 3d7pt_gpu.mlir:144:5
	movq	%rax, 232(%rsp)
	.loc	1 147 5                         # 3d7pt_gpu.mlir:147:5
	movq	392(%rsp), %rax
	movq	%rax, 96(%rsp)
	.loc	1 146 12                        # 3d7pt_gpu.mlir:146:12
	leaq	96(%rsp), %rax
	.loc	1 150 5                         # 3d7pt_gpu.mlir:150:5
	movq	%rax, 240(%rsp)
	.loc	1 153 5                         # 3d7pt_gpu.mlir:153:5
	movq	400(%rsp), %rax
	movq	%rax, 104(%rsp)
	.loc	1 152 12                        # 3d7pt_gpu.mlir:152:12
	leaq	104(%rsp), %rax
	.loc	1 156 5                         # 3d7pt_gpu.mlir:156:5
	movq	%rax, 248(%rsp)
	.loc	1 159 5                         # 3d7pt_gpu.mlir:159:5
	movq	408(%rsp), %rax
	movq	%rax, 112(%rsp)
	.loc	1 158 12                        # 3d7pt_gpu.mlir:158:12
	leaq	112(%rsp), %rax
	.loc	1 162 5                         # 3d7pt_gpu.mlir:162:5
	movq	%rax, 256(%rsp)
	.loc	1 165 5                         # 3d7pt_gpu.mlir:165:5
	movq	416(%rsp), %rax
	movq	%rax, 120(%rsp)
	.loc	1 164 12                        # 3d7pt_gpu.mlir:164:12
	leaq	120(%rsp), %rax
	.loc	1 168 5                         # 3d7pt_gpu.mlir:168:5
	movq	%rax, 264(%rsp)
	.loc	1 171 5                         # 3d7pt_gpu.mlir:171:5
	movq	424(%rsp), %rax
	movq	%rax, 128(%rsp)
	.loc	1 170 12                        # 3d7pt_gpu.mlir:170:12
	leaq	128(%rsp), %rax
	.loc	1 174 5                         # 3d7pt_gpu.mlir:174:5
	movq	%rax, 272(%rsp)
	.loc	1 177 5                         # 3d7pt_gpu.mlir:177:5
	movq	432(%rsp), %rax
	movq	%rax, 136(%rsp)
	.loc	1 176 12                        # 3d7pt_gpu.mlir:176:12
	leaq	136(%rsp), %rax
	.loc	1 180 5                         # 3d7pt_gpu.mlir:180:5
	movq	%rax, 280(%rsp)
	.loc	1 183 5                         # 3d7pt_gpu.mlir:183:5
	movq	440(%rsp), %rax
	movq	%rax, 144(%rsp)
	.loc	1 182 12                        # 3d7pt_gpu.mlir:182:12
	leaq	144(%rsp), %rax
	.loc	1 186 5                         # 3d7pt_gpu.mlir:186:5
	movq	%rax, 288(%rsp)
	.loc	1 189 5                         # 3d7pt_gpu.mlir:189:5
	movq	448(%rsp), %rax
	movq	%rax, 152(%rsp)
	.loc	1 188 12                        # 3d7pt_gpu.mlir:188:12
	leaq	152(%rsp), %rax
	.loc	1 192 5                         # 3d7pt_gpu.mlir:192:5
	movq	%rax, 296(%rsp)
	.loc	1 195 5                         # 3d7pt_gpu.mlir:195:5
	movq	456(%rsp), %rax
	movq	%rax, 160(%rsp)
	.loc	1 194 12                        # 3d7pt_gpu.mlir:194:12
	leaq	160(%rsp), %rax
	.loc	1 198 5                         # 3d7pt_gpu.mlir:198:5
	movq	%rax, 304(%rsp)
	.loc	1 200 12                        # 3d7pt_gpu.mlir:200:12
	subq	$8, %rsp
	...
	.loc	1 201 12                        # 3d7pt_gpu.mlir:201:12
	movq	%rbx, %rdi
	callq	mgpuStreamSynchronize@PLT
	.loc	1 202 12                        # 3d7pt_gpu.mlir:202:12
	movq	%rbx, %rdi
	callq	mgpuStreamDestroy@PLT
	movq	16(%rsp), %rdi                  # 8-byte Reload
	.loc	1 203 12                        # 3d7pt_gpu.mlir:203:12
	callq	mgpuModuleUnload@PLT
	.loc	1 204 5                         # 3d7pt_gpu.mlir:204:5
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        # -- End function
	.globl	_mlir_ciface_stencil_3d7pt      # -- Begin function _mlir_ciface_stencil_3d7pt
	.p2align	4, 0x90
	.type	_mlir_ciface_stencil_3d7pt,@function
_mlir_ciface_stencil_3d7pt:             # @_mlir_ciface_stencil_3d7pt
.Lfunc_begin1:
	.loc	1 206 0                         # 3d7pt_gpu.mlir:206:0
	.cfi_startproc
# %bb.0:
	pushq	%rax
	.cfi_def_cfa_offset 16
	...
	movq	%rdi, %r10
.Ltmp2:
	.loc	1 207 10 prologue_end           # 3d7pt_gpu.mlir:207:10
	movq	40(%rdi), %r9
	movq	32(%rdi), %r8
	movq	24(%rdi), %rcx
	movq	16(%rdi), %rdx
	movq	(%rdi), %rdi
	movq	8(%r10), %rsi
	.loc	1 227 5                         # 3d7pt_gpu.mlir:227:5
	pushq	64(%rax)
	.cfi_adjust_cfa_offset 8
	pushq	56(%rax)
	.cfi_adjust_cfa_offset 8
	...
	.loc	1 228 5                         # 3d7pt_gpu.mlir:228:5
	popq	%rax
	.cfi_def_cfa_offset 8
	retq
.Ltmp3:
.Lfunc_end1:
	.size	_mlir_ciface_stencil_3d7pt, .Lfunc_end1-_mlir_ciface_stencil_3d7pt
	.cfi_endproc
                                        # -- End function
...
.Lfunc_begin2:
	.loc	1 230 0                         # 3d7pt_gpu.mlir:230:0
	.cfi_startproc
# %bb.0:
	pushq	%rbp
	.cfi_def_cfa_offset 16
...
.Ltmp4:
	.loc	1 256 11 prologue_end           # 3d7pt_gpu.mlir:256:11
	cmpq	$9, %rax
	.loc	1 257 5                         # 3d7pt_gpu.mlir:257:5
	jg	.LBB2_3
	.p2align	4, 0x90
.LBB2_2:                                # =>This Inner Loop Header: Depth=1
	.loc	1 0 5 is_stmt 0                 # 3d7pt_gpu.mlir:0:5
	movq	(%rsp), %rdi                    # 8-byte Reload
	.loc	1 277 5 is_stmt 1               # 3d7pt_gpu.mlir:277:5
	movq	%rbp, %rsi
	movq	%rbx, %rdx
	movq	%r13, %rcx
	movq	%r12, %r8
	...
	addq	$96, %rsp
	.cfi_adjust_cfa_offset -96
	.loc	1 296 5                         # 3d7pt_gpu.mlir:296:5
	movq	%r14, %rdi
	movq	144(%rsp), %rsi
	movq	152(%rsp), %rdx
	movq	160(%rsp), %rcx
	...
	addq	$96, %rsp
	.cfi_adjust_cfa_offset -96
	.loc	1 297 11                        # 3d7pt_gpu.mlir:297:11
	incq	%rax
	.loc	1 256 11                        # 3d7pt_gpu.mlir:256:11
	cmpq	$9, %rax
	.loc	1 257 5                         # 3d7pt_gpu.mlir:257:5
	jle	.LBB2_2
.LBB2_3:
	.loc	1 300 5                         # 3d7pt_gpu.mlir:300:5
	addq	$56, %rsp
	.cfi_def_cfa_offset 56
	popq	%rbx
	.cfi_def_cfa_offset 48
...
.Ltmp5:
.Lfunc_end2:
	.size	stencil_3d7pt_iteration, .Lfunc_end2-stencil_3d7pt_iteration
	.cfi_endproc
                                        # -- End function
	.globl	_mlir_ciface_stencil_3d7pt_iteration # -- Begin function _mlir_ciface_stencil_3d7pt_iteration
	.p2align	4, 0x90
	.type	_mlir_ciface_stencil_3d7pt_iteration,@function
_mlir_ciface_stencil_3d7pt_iteration:   # @_mlir_ciface_stencil_3d7pt_iteration
.Lfunc_begin3:
	.loc	1 302 0                         # 3d7pt_gpu.mlir:302:0
	.cfi_startproc
# %bb.0:
	pushq	%rax
	.cfi_def_cfa_offset 16
	...
	movq	%rdi, %r10
.Ltmp6:
	.loc	1 303 10 prologue_end           # 3d7pt_gpu.mlir:303:10
	movq	40(%rdi), %r9
	movq	32(%rdi), %r8
	movq	24(%rdi), %rcx
	movq	16(%rdi), %rdx
	movq	(%rdi), %rdi
	movq	8(%r10), %rsi
	.loc	1 323 5                         # 3d7pt_gpu.mlir:323:5
	pushq	64(%rax)
	.cfi_adjust_cfa_offset 8
	pushq	56(%rax)
	.cfi_adjust_cfa_offset 8
	...
	pushq	48(%r10)
	.cfi_adjust_cfa_offset 8
	callq	stencil_3d7pt_iteration@PLT
	addq	$96, %rsp
	.cfi_adjust_cfa_offset -96
	.loc	1 324 5                         # 3d7pt_gpu.mlir:324:5
	popq	%rax
	.cfi_def_cfa_offset 8
	retq
.Ltmp7:
.Lfunc_end3:
	.size	_mlir_ciface_stencil_3d7pt_iteration, .Lfunc_end3-_mlir_ciface_stencil_3d7pt_iteration
	.cfi_endproc
                                        # -- End function
...
.Linfo_string4:
	.asciz	"_mlir_ciface_stencil_3d7pt"    # string offset=39
.Linfo_string5:
	.asciz	"stencil_3d7pt_iteration"       # string offset=66
.Linfo_string6:
	.asciz	"_mlir_ciface_stencil_3d7pt_iteration" # string offset=90
...
.LpubNames_start0:
	...
	.long	117                             # DIE offset
	.asciz	"_mlir_ciface_stencil_3d7pt_iteration" # External Name
	.long	67                              # DIE offset
	.asciz	"_mlir_ciface_stencil_3d7pt"    # External Name
	.long	0                               # End Mark
.LpubNames_end0:
