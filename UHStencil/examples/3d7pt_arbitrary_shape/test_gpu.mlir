module  {
  func @stencil_3d7pt(%arg0: memref<258x258x258xf64>, %arg1: memref<258x258x258xf64>) {
    ...
    gpu.launch blocks(%arg2, %arg3, %arg4) in (%arg8 = %1, %arg9 = %c1_6, %arg10 = %c1_6) threads(%arg5, %arg6, %arg7) in (%arg11 = %2, %arg12 = %3, %arg13 = %c1_6) {
      %4 = addi %c0, %arg2 : index
      %5 = addi %c0_0, %arg5 : index
      %6 = addi %c0_3, %arg6 : index
