...
public:
    ...
    static StringRef getStdStencilProgarmAttrName() { return "std.stencil_program"; }
    static StringRef getStdStencilIterationAttrName() { return "std.stencil_iteration"; }
    ...
    static bool isStdStencilProgram(FuncOp funcOp) {
        return !!funcOp->getAttr(getStdStencilProgarmAttrName());
    }
    ...
    static bool isStdStencilIteration(FuncOp funcOp) {
        return !!funcOp->getAttr(getStdStencilIterationAttrName());
    }
