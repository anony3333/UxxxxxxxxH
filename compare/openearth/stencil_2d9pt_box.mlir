...
%48 = constant 1.000000e-01: f64
%49 = constant 2.000000e-01: f64
%50 = constant 3.000000e-01: f64
%51 = stencil.access %arg2 [1, -1, 0] : (!stencil.temp<?x?x0xf64>) -> f64
%52 = stencil.access %arg2 [1, 0, 0] : (!stencil.temp<?x?x0xf64>) -> f64
%53 = stencil.access %arg2 [1, 1, 0] : (!stencil.temp<?x?x0xf64>) -> f64
%54 = stencil.access %arg2 [0, 0, 0] : (!stencil.temp<?x?x0xf64>) -> f64
%55 = stencil.access %arg2 [0, 1, 0] : (!stencil.temp<?x?x0xf64>) -> f64
%56 = stencil.access %arg2 [0, -1, 0] : (!stencil.temp<?x?x0xf64>) -> f64
%57 = stencil.access %arg2 [-1, -1, 0] : (!stencil.temp<?x?x0xf64>) -> f64
%58 = stencil.access %arg2 [-1, 0, 0] : (!stencil.temp<?x?x0xf64>) -> f64
%59 = stencil.access %arg2 [-1, 1, 0] : (!stencil.temp<?x?x0xf64>) -> f64
%60 = mulf %42, %51 : f64
%61 = mulf %43, %52 : f64
%62 = mulf %44, %53 : f64
%63 = mulf %45, %54 : f64
